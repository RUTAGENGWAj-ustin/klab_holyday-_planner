...
function chackuser() {
      ...
      if (Loged_user?.role =="admin") {
            return(<li><NavLink className="NavLink" to="User"><div className="dash-nav-icon"><BsFillPersonFill className="dash-nav-icon"/></div><p>User</p></NavLink></li>)
      }else{
            return("")
      }
}
...
<div className="left-dash">
                    ...
                    <div className="dash-nav">
                                 <div className="inner-dash-nav">
                                       <ul>
                                                 <li><NavLink className="NavLink" to="Dashboard"><div className="dash-nav-icon"><ImWindows className="dash-nav-icon"/></div><p className="nav_paragraph">Dashboard</p></NavLink></li>
                                                 <li><NavLink className="NavLink" to="User"><div className="dash-nav-icon"><BsFillPersonFill className="dash-nav-icon"/></div><p className="nav_paragraph">User</p></NavLink></li>
                                                 {chackuser}
